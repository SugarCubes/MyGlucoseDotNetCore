...
namespace MyGlucoseDotNetCore.Migrations
{
    ...
    [Migration("20181025065857_patients2")]
    partial class patients2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyGlucoseDotNetCore.Models.GlucoseEntry", b =>
                {
                    ...
                    b.Property<string>("PatientViewModelUserName");
                    ...
                    b.HasIndex("PatientViewModelUserName");
            ...
            modelBuilder.Entity("MyGlucoseDotNetCore.Models.ViewModels.PatientViewModel", b =>
                {
                    b.Property<string>("UserName")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("MyGlucoseDotNetCore.Models.ExerciseEntry", b =>
                {
                    ...
                    b.HasOne("MyGlucoseDotNetCore.Models.ViewModels.PatientViewModel")
                        .WithMany("ExerciseEntries")
            ...
            modelBuilder.Entity("MyGlucoseDotNetCore.Models.GlucoseEntry", b =>
                {
                    ...
                    b.HasOne("MyGlucoseDotNetCore.Models.ViewModels.PatientViewModel")
                        .WithMany("GlucoseEntries")
                        .HasForeignKey("PatientViewModelUserName");
                });
